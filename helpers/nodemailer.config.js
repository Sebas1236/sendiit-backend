...
const sendDataPackage = (origen, destino, usuario, tamano, destinatario, descripcion,codigo) => {
    //console.log('Sending recover email...');
    //console.log(`http://127.0.0.1:5173/auth/reset-password/${uid}/${token}/`);
    transport.sendMail({
        from: user,
                ...
                <td >
                    <table width="100%">
                        <tr>
                            ...
                            <p  style="font-size: 15px; line-height:23px;padding:5px 15px 15px;">Locker de origen: ${ origen }.</p>
                            <p  style="font-size: 15px; line-height:23px;padding:5px 15px 15px;">Locker de destino: ${ destino }.</p>
                            ...
                            <img src= ` + codigo +  `>
                            <p  style="font-size: 15px; line-height:23px;padding:5px 15px 15px;">Para dejar el paquete en ${ origen } deberas escanear el código QR en el locker y depositar el paquete.</p>
                            </td>
                        </tr>
                    </table>
                </td>
